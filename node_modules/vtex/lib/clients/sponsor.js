...
class Sponsor extends api_1.IOClient {
    constructor(context, options) {
        ...
        this.setEdition = async (account, workspace, editionApp) => {
    ...
    get routes() {
        return {
            ...
            setEdition: (account, workspace) => `http://tenant-provisioner.vtex.${this.region}.vtex.io/${this.account}/master/tenants/${account}/migrate?tenantWorkspace=${workspace}`,
