...
const switchToPreviousAccount = async (previousAccount, previousWorkspace) => {
    ...
    if (previousAccount !== currentAccount) {
        const canSwitchToPrevious = await promptDeprecateOnVendor(utils_1.switchAccountMessage(previousAccount, currentAccount));
        if (canSwitchToPrevious) {
            return switch_1.default(previousAccount, { workspace: previousWorkspace });
        }
    }
};
