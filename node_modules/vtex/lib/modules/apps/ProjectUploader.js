...
const Builder_1 = require("../../clients/Builder");
...
class ProjectUploader {
    ...
    // prettier-ignore
    async sendWholeProject(operation, files, requestParams, publishTag) {
